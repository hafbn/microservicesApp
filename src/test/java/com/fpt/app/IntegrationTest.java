...
import com.fpt.app.MonoApp;
import com.fpt.app.config.AsyncSyncConfiguration;
import com.fpt.app.config.EmbeddedSQL;
...
@SpringBootTest(classes = { MonoApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL

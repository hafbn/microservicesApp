...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fpt.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fpt.app.security.DomainUserDetailsService", "createSpringSecurityUser");
